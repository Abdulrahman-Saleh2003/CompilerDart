// Generated from DartLexer.g4 by ANTLR 4.13.2
...
public class DartLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"WITH", "YIELD", "PRINT", "INT", "DOUBLE", "STRING", "BOOL", "NUM", "TRIPLE_DOT_QUESTION", 
			"TRIPLE_DOT", "CASCADE_NULL", "CASCADE", "NULL_AWARE_INDEX", "NULL_AWARE_DOT", 
			"NULL_COALESCING_ASSIGN", "NULL_COALESCING", "ARROW", "EQ_EQ", "NOT_EQ", 
			"LTE", "GTE", "AND", "OR", "INC", "DEC", "UNSIGNED_SHIFT_ASSIGN", "UNSIGNED_SHIFT", 
			"RIGHT_SHIFT_ASSIGN", "LEFT_SHIFT_ASSIGN", "RIGHT_SHIFT", "LEFT_SHIFT", 
			"PLUS_ASSIGN", "MINUS_ASSIGN", "MUL_ASSIGN", "DIV_ASSIGN", "INT_DIV_ASSIGN", 
			"MOD_ASSIGN", "AND_ASSIGN", "OR_ASSIGN", "XOR_ASSIGN", "INT_DIV", "ASSIGN", 
			"PLUS", "MINUS", "MUL", "DIV", "MOD", "NOT", "LT", "GT", "BIT_AND", "BIT_OR", 
			"BIT_XOR", "BIT_NOT", "QUESTION", "COLON", "SEMICOLON", "COMMA", "DOT", 
			"AT", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "LBRACKET", "RBRACKET", 
			"HEX_LITERAL", "INT_LITERAL", "DOUBLE_LITERAL", "SYMBOL_LITERAL", "STRING_LITERAL", 
			"RAW_TRIPLE_DOUBLE_QUOTE_STRING", "RAW_TRIPLE_SINGLE_QUOTE_STRING", "RAW_DOUBLE_QUOTE_STRING", 
			"RAW_SINGLE_QUOTE_STRING", "TRIPLE_DOUBLE_QUOTE_STRING", "TRIPLE_SINGLE_QUOTE_STRING", 
			"DOUBLE_QUOTE_STRING", "SINGLE_QUOTE_STRING", "IDENTIFIER", "SCRIPT_TAG", 
			"DOC_COMMENT", "LINE_COMMENT", "BLOCK_COMMENT", "WS"
		};
	}
